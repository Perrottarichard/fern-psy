...
import { Container, Chip, Typography, Card , CardHeader, CardActions, CardActionArea, Menu, MenuItem, Button, CircularProgress} from '@material-ui/core';
...
const ForumDisplayAll = () => {
  ...
  const {userId} = useParams() //for myquestions
